...
plot <- draws %>% ggplot() +
  geom_bar(aes(`priorpred[trial_no]`), fill = 'pink', position = 'stack') +
  ggtitle(label = "Prior") + 
draws %>% ggplot() +
  geom_bar(aes(`posteriorpred[trial_no]`), fill = 'lightblue', position = 'stack') +
  ggtitle(label = "Posterior") +
draws %>% ggplot() +
  geom_bar(aes(`posteriorcorrect[trial_no]`), fill = 'green', position = 'stack') + 
  ggtitle(label = "Correct")
