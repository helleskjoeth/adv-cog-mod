...
first_round <- function(trials, sd){
  rating1 <- round(inv_logit_scaled(rnorm(trials, 0.35, sd))*9, 0)
...
sim_d_and_fit_SB <- function(seed, trials, bias, sd){
...
test_SB <- sim_d_and_fit_SB(seed, trials, bias, sd)
```
...
sim_d_and_fit_WB <- function(trials, weight_self, weight_other, bias, sd){
...
# checking simulated data
```{r generate data}
WB_data <- sim_data_WB(trials, weight_self, weight_other, bias, sd)
```
