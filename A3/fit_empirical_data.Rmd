...
draws_SB %>% mutate(
  ...
  theme_bw()+ 
  labs(title = "SB: participant 1, trial 1, faceID 10") +
...
draws_SB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "SB: participant 1, trial 2, faceID 11") +
...
draws_SB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "SB: participant 1, trial 10, faceID 19") + # goes up to 9
...
draws_SB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "SB: participant 1, trial 13, faceID 22") 
...
draws_WB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) +
  theme_bw()+ 
  labs(title = "WB: participant 1, trial 1, face ID 10") +
...
draws_WB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "WB: participant 1, trial 2, face ID 11") +
...
draws_WB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "WB: participant 1, trial 10, faceID 19") +
...
draws_WB %>% mutate(
  ...
  scale_x_continuous(breaks = scales::pretty_breaks(n = 9)) + 
  theme_bw()+ 
  labs(title = "WB: participant 1, trial 13, faceID 22")
...
0.699785 + 0.6211112 # 1.320896 0 1.32 %
```
