...
ggplot(test) +
  ...
  geom_density(aes(bias_winTrue), fill="red", alpha=0.3) +
...
ggplot(test) +
  ...
  geom_density(aes(bias_loseTrue), fill="red", alpha=0.3) +
  xlab("Rate") +
  ylab("Posterior Density") +
  theme_classic() + 
...
```{r}
# prior predictions - when losing and choosing left/0
ggplot(test) +
  geom_histogram(aes(prior_preds_LL), color="darkblue", fill="blue", alpha=0.3) +
...
```{r} 
ggplot(test) + # when the agent loses and choses right
  geom_histogram(aes(prior_preds_LR), color="darkblue", fill="blue", alpha=0.3) +
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + 
...
ggplot(test) +
  ...
  ylab("Posterior Density") +
  theme_classic() + 
  labs(title = "Prior predicted next choices when the agent choses 0 and wins")
...
ggplot(test) +
  ...
  ylab("Posterior Density") +
  theme_classic() +
  labs(title = "Prior predicted next choices when the agent choses 1 and wins")
