...
# så count hvor mange gange, man har eks. valgt venstre og tabt
...
temp = ggarrange(p1, p2)
#annotate_figure(temp, fig.lab = "Prior-posterior update checks")
temp
...
testtest <- sim_d_and_fit_prior_sensitivity(0,0.5,0,0.5)
